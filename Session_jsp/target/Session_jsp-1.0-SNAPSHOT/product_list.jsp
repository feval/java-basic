<%@ page import="com.bite.util.CookieUtils " %><%--
...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <div class="col-md-2">
        <%--请求后台,获取参数id--%>
        <a href="/getProductById?id=1">
            <img src="products/1/cs10001.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/getProductById?id=1" style='color:green'>休闲衣服</a></p>
        <p><font color="#FF0000">商城价：&yen;599.00</font></p>
    </div>
    ...
    <div class="col-md-2">
        ...
        <p><font color="#FF0000">商城价：&yen;399.00</font></p>
    </div>

    <div class="col-md-2">
        <a href="/getProductById?id=3">
            <img src="products/1/cs10003.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/getProductById?id=3" style='color:green'>包</a></p>
        <p><font color="#FF0000">商城价：&yen;1299</font></p>
    </div>

    <div class="col-md-2">
        <a href="getProductById?id=4">
            <img src="products/1/cs10004.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="getProductById?id=4" style='color:green'>休闲短袖</a></p>
        <p><font color="#FF0000">商城价：&yen;499</font></p>
    </div>
    <div class="col-md-2">
...
<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
    ...
    <h4 style="width: 50%;float: left;font: 14px/30px " 微软雅黑 ";">浏览记录<small><a href="/clearHistory">清空</a></small></h4>
